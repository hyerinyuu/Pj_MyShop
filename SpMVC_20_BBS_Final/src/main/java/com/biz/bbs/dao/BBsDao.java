...
public interface BBsDao {
	...
	@Select("SELECT * FROM tbl_bbs_final ORDER BY b_date_time DESC")
	public List<BBsVO> selectAll();
	
	@Select("SELECT * FROM tbl_bbs_final WHERE b_id = #{b_id}")
	...
	@Delete("DELETE FROM tbl_bbs_final WHERE b_id = #{b_id}")
