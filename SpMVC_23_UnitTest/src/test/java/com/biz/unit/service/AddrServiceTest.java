...
/*
 *  spring framework환경에서 test를 수행하기 위한 초기화 구분
 *  @ContextConfiguration
 *  spring 프로젝트의 bean등 설정파일을 불러와서
 *  spring 프로젝트 실행환경과 동일하게 테스트를 수행할 수 있도록 설정
 *  
...
public class AddrServiceTest {
	...
	/*
	 * spring bean으로 설정된 AddrService를 가져와서 사용할 수 있도록 설정
